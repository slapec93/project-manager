class ProjectCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project_comment.save
        format.html { redirect_to project_comment_url(@project_comment), notice: "Project comment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @project_comment.update(project_comment_params)
        format.html { redirect_to project_comment_url(@project_comment), notice: "Project comment was successfully updated." }
  ...
  private
    ...
    def project_comment_params
      params.require(:project_comment).permit(:content, :project_id, :user_id)
    end
end
